...
{{set_table_name('%klaviyo%dropped_email')}}  
{% endset %} 
...
{% for i in results_list %}
    ...
    FROM (
        ...
        ev.group_ids,
        ev.event_id,
        bounce_delivery_info.action_id,
        bounce_delivery_info.add_exclusion,
        bounce_delivery_info.is_autoresponder,
        bounce_delivery_info.reason,
        {% if var('timezone_conversion_flag') %}
        ...
        LEFT JOIN UNNEST (extra.bounce_delivery_info) as bounce_delivery_info
